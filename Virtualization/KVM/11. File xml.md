...
- **B1 :** Chuẩn bị file `.xml` :
	```
	# nano /etc/libvirt/qemu/Ubuntu22.04.xml
	```
	Thêm nội dung sau :
	```xml
	<domain type='kvm'>
	  ...
	  <devices>
		...
		<disk type="file" device="cdrom">
		  <driver name="qemu" type="raw"/>
		  <source file="/var/lib/libvirt/fileiso/ubuntu-22.04.5-live-server-amd64.iso"/>
	...
	- Máy ảo này sẽ có thông số :
		...
		- Máy ảo được boot từ CDROM : `/var/lib/libvirt/images/ubuntu-22.04.5-live-server-amd64.iso`
